...
const Routes = () => (
   <Router>
      <Scene key = "root">
         ...
         <Scene key="MenuDrawer" drawer={true} component={Menu} contentComponent={MenuDrawer} title="Monitoring" navigationBarStyle={styles.navigationBarTitleStyle} navBarButtonColor='white' >
